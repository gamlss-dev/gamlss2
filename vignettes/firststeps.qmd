...
This model converges in 15 iterations and requires only about 7.5 seconds of computation time, 
...
This model converges in 14 iterations in about 26 seconds. After estimation, results can be
