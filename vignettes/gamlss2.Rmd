...
This is done to minimize the object's size. The model smoothing parameters are estimated
using the local BIC in this example. Note that the model is quite complex, as it includes
